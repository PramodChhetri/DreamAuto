...
<h2 class="font-bold text-4xl text-black-700">Parts</h2> 
...
@include('layouts.message')
    ...
    <div class="my-4 text-right px-10">
        <a href="{{route('products.create')}}" class="bg-amber-400 text-black px-4 py-2 rounded-lg shadow-md hover:shadow-amber-300">Add Parts</a>
    </div>
    ...
    <table id="mytable" class="display">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$product->id}}</td>
                <td><img class="w-44" src="{{ asset('images/products/'.$product->photopath_1) }}" alt=""></td>
                <td>{{$product->name}}</td>
                <td>{{$product->code}}</td>

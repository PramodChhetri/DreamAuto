        ...
        <div class="flex">
            ...
            <div class="sidebar w-60 min-h-screen bg-gray-800 shadow-lg flex flex-row justify-center py-24 ">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="{{route('products.index')}}" class="text-xl text-white m-3 border-b-2 hover:bg-green-700 hover:text-white">Parts</a>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            <a href="{{ route('dashboard') }}">
                                <span class="font-bold text-2xl text-green-700 hover:bg-gray-400">Dream Auto Pvt. Ltd.</span>
                            </a>
                        </div>
